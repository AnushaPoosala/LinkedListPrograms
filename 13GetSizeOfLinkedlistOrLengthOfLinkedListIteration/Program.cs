...
//  https://www.youtube.com/watch?v=r6uVnbJJLtM&list=PLt4nG7RVVk1gDMcCZkpjOxZS4XMro29DU&index=13
//13GetSizeOfLinkedlistOrLengthOfLinkedListIteration
namespace _13GetSizeOfLinkedlistOrLengthOfLinkedListIteration
{
    public class Node
    {
    ...
    public class LinkedList
    {
        ...
        public int LinkedListSizeIteration(Node node)
        {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ll.Print(node);
            Console.WriteLine("LinkedList size is:{0}", ll.LinkedListSizeIteration(node)); Console.WriteLine();
            node = ll.DeleteAtPosition(node, 3);
            ll.Print(node);
            Console.WriteLine("LinkedList size is:{0}", ll.LinkedListSizeIteration(node));
        }
    }
}